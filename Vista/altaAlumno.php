  ...
  <div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <a class="moveL" aria-current="page" href="#"><img src="../img/home3.png" alt="Inicio" width="40"
            height="40"></a>
    ...
    <form action="altaAlumno.php" class="contenedorExt" method="post">
      ...
      <div class="columna1">
        ...
        <div> <input type="text" name="apellido" placeholder="#Apellidos" id="apellidos" required pattern="[A-Za-z]{2,254}"
            required style=width:200px;height:20px;>
        </div>
        ...
        <div> <select name="DNIPassT" style=width:90px;height:25px; id="selecDocumento" onchange="verificarOpcion()"
          ...
          <input type="text" onkeypress="return segunSeleccion(event);" minlength="8" maxlength="9" required name="dniP"
            placeholder="#Numero" id="documento" style=width:106px;height:20px; disabled>
        </div>
    
        <div> <label for="email" id="etiqueta">E-mail</label> </div>
    
        <div> <input type="email" name="email" placeholder="#Email" id="email" style=width:200px;height:20px; required>
        </div>
      ...
      <div class="columna2">
        ...
        <div> <input type="text" name="codC" placeholder="#CodArea" id="codArea" style=width:85px;height:20px; required
            pattern="[0-9]{1,5}">
        ...
        <div> <input type="email" name="emailC" placeholder="#Email" id="emailContacto" style=width:200px;height:20px;>
        </div>
        ...
        <div> <input type="text" name="localidad" placeholder="#Localidad" id="localidad" style=width:200px;height:20px;>
        </div>
...
if ( isset($_POST["send"]))  {
  ...
  require("../Controlador/ingresarAlumno.php");
