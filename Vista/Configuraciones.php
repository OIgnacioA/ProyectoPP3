...
<body>
  <header>
    ...
    <div id="cerrarS">
      <button id="btnCerrarS" type="button" class="btn btn-secondary"> <a href="PaginaInicio.html">Cerrar
          Sesion</a></button>
    </div>
    <div class="container">
          ...
          <div class="col">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
              <div class="container-fluid ">
                <div class="imgHome">
                  <a aria-current="page" href="#"><img src="../img/home3.png" alt="Inicio" width="40" height="40"></a>
