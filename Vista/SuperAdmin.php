...
<html lang="en">
  ...
  <body>
    <header>
      ...
      <div id="cerrarS">
        <button id="btnCerrarS" type="button" class="btn btn-secondary"> <a href="PaginaInicio.html">Cerrar Sesion</a></button>
      </div>
      <div class="container">
            ...
            <div class="col">
              <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid ">
                  <div class="imgHome">
                    <a aria-current="SuperAdmi.html" href="SuperAdmi.html"><img src="../img/home3.png" alt="Inicio"></a>
